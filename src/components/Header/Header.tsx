...
export function Header({ isSticky, onRsvp }: HeaderProps) {
  return (
    <header
      className={`relative flex w-full max-w-[1200px] flex-col items-stretch gap-4 rounded-[48px] bg-bg p-3 pt-[140px] shadow-[var(--shadow-header)] transition-shadow duration-300 max-[1100px]:pt-[140px] min-[1100px]:flex-row min-[1100px]:items-center min-[1100px]:justify-end min-[1100px]:gap-8 min-[1100px]:pt-3 ${
    ...
    >
      ...
      <nav
        className="flex flex-col items-stretch min-[600px]:flex-row min-[600px]:flex-wrap min-[600px]:items-center min-[600px]:justify-center min-[1100px]:justify-end"
      ...
      <div
        className={`grid self-center transition-[grid-template-columns,opacity] duration-300 ease-in-out min-[1100px]:self-auto ${
          isSticky
